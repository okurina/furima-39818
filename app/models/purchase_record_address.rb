class PurchaseRecordAddress
  ...
  attr_accessor :item_id, :user_id, :region_id, :post_cord, :city, :street, :building, :telephone, :token
  ...
  def save
    ...
    Address.create(post_cord:, region_id:, city:, street:, building:,
                   telephone:, purchase_record_id: purchase_record.id)
  end
end
